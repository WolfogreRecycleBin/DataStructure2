...
//----------------------------------------------------------------------------------------------
//added to do the homework in P310-8
public:
	void FindLargerThan(const ElemType &x);
protected:
	void FindLargerThan(const ElemType &x, BinTreeNode<ElemType> *p);
//----------------------------------------------------------------------------------------------
};
//----------------------------------------------------------------------------------------------
//added to do the homework in P310-8
template <class ElemType>
void BinarySortTree<ElemType>::FindLargerThan(const ElemType &x)
{
	FindLargerThan(x,root);
	cout << endl;
}
